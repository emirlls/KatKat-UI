...
export const leaderboardService = {
  getLeaderboard: (cityId?: number, districtId?: number, neighborhoodId?: number, maxResultCount = 20) =>
    api.get<LeaderboardDto[]>('/complexes/leaderboard', { cityId, districtId, neighborhoodId, maxResultCount }),
